package bromodachi.urlshortner.advice

import bromodachi.urlshortner.ApiErrorCodes
import bromodachi.urlshortner.dto.response.ErrorResponseDto
import bromodachi.urlshortner.exceptions.ServerRuntimeException
...
class GlobalExceptionHandler {
    ...
    fun handleRuntimeExceptions(exception: ServerRuntimeException): ResponseEntity<Any> {
